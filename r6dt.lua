...
getgenv().GTOWER_DEFENSE_INFINITY_PET = {"Electric Eel","Nuclear Dominus","Nightmare Cyclops","Blurred Owl","Arcade Angelus","Tech Samurai Axolotl","Abyssal Turtle","Crystal Giraffe"}
